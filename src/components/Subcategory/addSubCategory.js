  ...
  const changeOnClick = (e) => {
    e.preventDefault();
       ...
       setchallenges("");
        ...
        axios
          .post("http://ec2-35-83-63-15.us-west-2.compute.amazonaws.com:8000/admin/addSubCategoryToAdminPanel", formData)
                          ...
                          <form action="" method="post" onSubmit={changeOnClick}>
                            ...
                            <div className="form-group">
                              ...
                              <input
                                ...
                                id="challenges"
                                value={challenges}
                                onChange={(e) => setchallenges(e.target.value)}                                placeholder="rules"
                              />
                            </div>
